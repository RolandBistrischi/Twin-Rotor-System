...
folderPaths = {
    'D:\MATLAB\Licenta_fractionar\Twin-Rotor-System\Twin rotor\date_regulatoare\Reg_TFOIDFFID\H11_nou\', ...
    'D:\MATLAB\Licenta_fractionar\Twin-Rotor-System\Twin rotor\date_regulatoare\Reg_TFOIDFFID\H22_nou\', ...
...
H11_TID= minreal(oustapp( loadedData(1).RegTFOIDFFID_H11_ISE.regulator));

H22_TID= minreal(oustapp( loadedData(2).RegTFOIDFFID_H22_ISE.regulator));


[num_TFOIDFFID11, den_TFOIDFFID11] = tfdata(tf(H11_TID), 'v');

[num_TFOIDFFID22, den_TFOIDFFID22] = tfdata(tf(H22_TID), 'v');
