...
%%
azimuth=load("D:\MATLAB\Licenta_fractionar\Twin-Rotor-System\Twin rotor\Simulink tests\Reg_MultiPID\IAE\date_step_azimuth.mat");
pitch=load("D:\MATLAB\Licenta_fractionar\Twin-Rotor-System\Twin rotor\Simulink tests\Reg_MultiPID\IAE\date_step_pitch.mat");
...
legend('ord 1 cu ord 2','ord 2 cu ord 4','ord 3 cu ord 1','ord 5 cu ord 3','inițial');
...
BBBBBBBB1= loadedData(1).RegFrac_H11_IAE(1)  .regulator
BBBBBBBB2=loadedData(2).RegFrac_H22_IAE(1) .regulator
H11_MultiPID_IAE= minreal(oustapp(BBBBBBBB1));

H22_MultiPID_IAE= minreal(oustapp( BBBBBBBB2));


[num_MultiPID_IAE11, den_MultiPID_IAE11] = tfdata(tf(H11_MultiPID_IAE), 'v');

[num_MultiPID_IAE22, den_MultiPID_IAE22] = tfdata(tf(H22_MultiPID_IAE), 'v');
