...
folderPaths = {
    'D:\MATLAB\Licenta_fractionar\Twin-Rotor-System\Twin rotor\date_regulatoare\Reg_PIDD2\H11_nou\', ...
    'D:\MATLAB\Licenta_fractionar\Twin-Rotor-System\Twin rotor\date_regulatoare\Reg_PIDD2\H22_nou\', ...
...
H11_PIDD= minreal(oustapp( loadedData(1).RegPIDD_H11_ISE.regulator));

H22_PIDD= minreal(oustapp( loadedData(2).RegPIDD_H22_ISE.regulator));


[num_PIDD11, den_PIDD11] = tfdata(tf(H11_PIDD), 'v');

[num_PIDD22, den_PIDD22] = tfdata(tf(H22_PIDD), 'v');
