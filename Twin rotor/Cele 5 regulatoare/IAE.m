...
[bestJ_H11, bestReg_H11] = findBestRegulators(n, H11, RegFrac_H11_limitat_IAE, 5,'IAE');
[bestJ_H22, bestReg_H22] = findBestRegulators(n, H22, RegFrac_H22_limitat_IAE, 5,'IAE');
%%
close all;clc;
for i=1:5
