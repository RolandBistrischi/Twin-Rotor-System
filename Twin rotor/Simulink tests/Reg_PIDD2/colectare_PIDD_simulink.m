...
H11_TID= minreal(oustapp( loadedData(1).RegPIDD_H11_ITSE.regulator));

H22_TID= minreal(oustapp( loadedData(2).RegPIDD_H22_ITSE.regulator));


[num_PIDD11, den_PIDD11] = tfdata(tf(H11_TID), 'v');

[num_PIDD22, den_PIDD22] = tfdata(tf(H22_TID), 'v');
