...
BBBBBBBB1= loadedData(1).RegFrac_H11_ISE(2)  .regulator
BBBBBBBB2=loadedData(2).RegFrac_H22_ISE(2) .regulator
H11_MultiPID_ISE= minreal(oustapp(BBBBBBBB1));

H22_MultiPID_ISE= minreal(oustapp( BBBBBBBB2));


[num_MultiPID_ISE11, den_MultiPID_ISE11] = tfdata(tf(H11_MultiPID_ISE), 'v');

[num_MultiPID_ISE22, den_MultiPID_ISE22] = tfdata(tf(H22_MultiPID_ISE), 'v');
