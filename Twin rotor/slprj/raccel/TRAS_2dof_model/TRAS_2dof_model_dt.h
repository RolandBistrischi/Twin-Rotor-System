...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . erbrcq20ws ) , 0 , 0 , 78 } ,
{ ( char_T * ) ( & rtDW . di3vciqhvk . LoggedData [ 0 ] ) , 11 , 0 , 9 } , {
( char_T * ) ( & rtDW . pn4vsggslw ) , 10 , 0 , 11 } } ; static
DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . control_a
[ 0 ] ) , 0 , 0 , 782 } , { ( char_T * ) ( & rtP . Internal_A_ir ) , 7 , 0 ,
276 } } ; static DataTypeTransitionTable rtPTransTable = { 2U ,
rtPTransitions } ;
